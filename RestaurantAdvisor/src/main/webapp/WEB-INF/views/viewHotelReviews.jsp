...
<body>
	<h1>THERE ARE A TOTAL OF ${reviewListSize} FOR YOUR HOTEL</h1>
	<table>
		<tr>
			<th>REVIEWER</th>
			<th>HEADLINE</th>
		...
		<c:forEach var="row" items="${requestScope.reviewList}">
			<tr>
				<td><input type="text" readonly="readonly" name="REVIEWER"
					value="${row.reviewerLoginDetails.userDetails.firstName},${row.reviewerLoginDetails.userDetails.lastName} " /></td>
